...
export const ImagenesProvider = ({ children }) => {
  ...
  const [imagenes, setImagenes] = useState([
    ...
    { url: "https://i.postimg.cc/0yQdb0tw/Whats-App-Image-2024-11-14-at-2-12-10-PM.jpg", titulo: "Tenga en cuenta", descripcion: "🚔👮‍♂️ El Gaula de la Policía te recuerda: ¡Cuelga y bloquea! No caigas en extorsión ⚠️. Reporta al ☎️ 165 gratis. ¡Protege tu seguridad del 👤🕵️!" },
