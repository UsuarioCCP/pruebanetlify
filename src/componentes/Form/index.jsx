...
const Form = () => {
  ...
  const buttonClass = (buttonId) => {
    return `flex items-center justify-start w-full py-2 px-5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 group ${activeButton === buttonId ? 'shadow-lg text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'  : ''}`;
  };

  const iconClass = (buttonId) => { 
    return activeButton === buttonId ? 'w-6 h-6 text-white' : 'w-6 h-6 text-gray-800 dark:text-white';
  };
  ...
  return (
    <div className="grid fixed top-28">
      ...
      <aside className="fixed mt-35 left-0 z-40 w-64 h-[39rem] transition-transform -translate-x-full sm:translate-x-0 border-4 border-red-700 border-solid rounded-lg dark:border-gray-700" aria-label="Sidebar">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <button onClick={() => handleOptionClick('reproductor', 'reproductor')} className={buttonClass('reproductor')}>
                <svg className={iconClass('reproductor')} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <span className="ms-2 whitespace-nowrap">Reproductor de video</span>
              </button>
            </li>
            <li>
              <button onClick={() => handleOptionClick('carousel', 'carousel')} className={buttonClass('carousel')}>
                <svg className={iconClass('carousel')} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li>
              <button onClick={() => handleOptionClick('baner', 'baner')} className={buttonClass('baner')}>
                <svg className={iconClass('baner')} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <div className="container h-[39rem] fixed top-28 overflow-x-auto bg-white border-4 border-red-700 border-solid rounded-lg dark:border-gray-700" id="contenido-tabla">
        <div className="">
